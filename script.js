...
let highRecord = parseInt(localStorage.totalRecord || JSON.stringify(0));
let totalRecord = parseInt(localStorage.currentCounter || JSON.stringify(0));

document.getElementById('currentCounter').innerText = sessionCount + '';
document.getElementById('highRecord').innerText = sessionCount + '';
document.getElementById('totalRecord').innerText = sessionCount + '';
